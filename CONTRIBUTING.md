...
This outlines how to propose a change to practica2pinguinos. For a
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("Kiaramanacasa/practica2pinguinos", fork = TRUE)`.
...
[Contributor Code of
Conduct](https://kiaramanacasa.github.io/practica2pinguinos/CODE_OF_CONDUCT.md).
